...
window.BG = (function () {
  ...
  var SENS = [
    { id: 'limier', nom: 'Nez de limier',
      face: '+3 à flairer, pister, reconnaitre à l’odeur. Tu sens la peur, le sang, la maladie.',
    ...
    { id: 'yeuxnuit', nom: 'Yeux de nuit',
      ...
      ombre: '−2 en plein soleil découvert, sous le lichen et dans les spores. Du noir à la pleine lumière : ébloui·e un tour.' },
    ...
    { id: 'langue', nom: 'Langue chimique',
      face: 'Tu goutes la matière : poison, teinture, greffe récente, sang vieux de trois jours. +3 pour identifier une substance ; sur un franc, tu sais qui l’a posée.',
      ombre: 'Aucune portée : il faut toucher, et ça se voit. Tu encaisses ce que tu goutes.' },
  ...
  var POSITIONS = [
    { id: 'fluviale', nom: 'Lignée fluviale', especes: 'loutres, ragondins, castors, martins-pêcheurs',
      acces: 'Tout passage sur le fleuve. Un·e batelier·ère ne te refuse ni embarquement, ni renseignement, ni abri pour la nuit.',
    ...
    { id: 'nocturnes', nom: 'Nocturnes', especes: 'chauves-souris, genettes, chats, hiboux',
      ...
      amont: 'La nuit sans lampes est à toi. Dans un village où chacun surveille chacun, tu es lae seul·e à savoir qui rentre tard.',
  ...
  var FAMILLES = [
    { id: 'prise', nom: 'Prise', stats: ['poigne', 'patte'], devise: 'Le corps entier : lutte, voltige, contact.',
      greffes: [
        ...
        { nom: 'Rebond',
          ...
          variantes: [
            { nom: 'Ricochet', texte: 'Tu traverses une zone tenue par des ennemi·es sans être arrêté.' },
            { nom: 'Portée', texte: 'Tu emmènes un·e allié·e consentant·e.' }] }
      ] },
    { id: 'traque', nom: 'Traque', stats: ['poigne', 'nez'], devise: 'Chasser, user, achever.',
      greffes: [
        ...
        { nom: 'Acculer',
          ...
          variantes: [
            { nom: 'Meute', texte: 'Un·e allié·e au Contact profite de l’effet.' },
    ...
    { id: 'souche', nom: 'Souche', stats: ['poigne', 'seve'], devise: 'La force du végétal.',
      greffes: [
        { nom: 'Faire pousser',
          fer: 'Une racine jaillit dans une zone Proche. La zone devient encombrée — la quitter coute tout le déplacement — pendant Rang tours.',
    ...
    { id: 'ascendant', nom: 'Ascendant', stats: ['poigne', 'verbe'], devise: 'La présence qui contraint.',
      greffes: [
        { nom: 'Tenir la salle',
          fer: 'Ce tour, tout·e ennemi·e de ta zone qui attaque quelqu’un d’autre que toi subit −2 à son jet.',
        ...
        { nom: 'Ordre',
          fer: 'Un·e allié·e agit immédiatement, hors de son tour, avec +Rang à son jet.',
          calme: 'Tu fais faire à quelqu’un ce qu’iel savait déjà faire mais n’osait pas.',
          variantes: [
    ...
    { id: 'escamote', nom: 'Escamote', stats: ['patte', 'nez'], devise: 'La main qui sait où aller.',
      greffes: [
        ...
        { nom: 'Point faible',
          ...
          variantes: [
            { nom: 'Partagé', texte: 'Tu le dis à voix haute : un·e allié·e en profite à ta place.' },
    ...
    { id: 'officine', nom: 'Officine', stats: ['patte', 'seve'], devise: 'Greffer fin, distiller, recoudre.',
      greffes: [
        { nom: 'Recoudre',
          fer: 'Un·e allié·e au Contact récupère 1d6 + Rang points de vie, ou se relève de zéro avec 1 point de vie — et ça lui épargne une marque si c’est fait à temps.',
          calme: 'Tu soignes une blessure, une coque, un mur. En une scène, tu peux enrayer une marque fraiche.',
          variantes: [
            { nom: 'Sutures', texte: '1d4 seulement, mais sur deux allié·es.' },
        ...
        { nom: 'Fiole',
          ...
          variantes: [
            ...
            { nom: 'À retardement', texte: 'La surface n’apparait qu’au tour suivant, ou quand tu le décides.' }] }
      ] },
    { id: 'faux', nom: 'Faux-semblant', stats: ['patte', 'verbe'], devise: 'Mentir avec les mains.',
      greffes: [
        { nom: 'Passe-passe',
          ...
          variantes: [
            { nom: 'Leurre', texte: 'Tu diriges l’attaque vers un·e autre ennemi·e au lieu de te protéger.' },
            { nom: 'Doublure', texte: 'L’effet protège un·e allié·e de ta zone.' }] },
        { nom: 'Papiers',
          fer: 'Tu montres quelque chose. Un·e ennemi·e capable de lire hésite un tour : iel ne t’attaque pas tant que tu ne le touches pas.',
      ...
      greffes: [
        { nom: 'Écouter le lieu',
          ...
          variantes: [
            ...
            { nom: 'En sourdine', texte: 'Tu partages la perception avec tes allié·es.' }] },
        { nom: 'Diagnostic',
          ...
          variantes: [
            ...
            { nom: 'Antidote', texte: 'Tu protèges un·e allié·e au lieu d’affaiblir : +2 contre ce que tu as nommé.' }] }
      ] },
    { id: 'instruction', nom: 'Instruction', stats: ['nez', 'verbe'], devise: 'La vérité arrachée.',
      greffes: [
        { nom: 'Interroger',
          fer: 'Tu poses une question à voix haute à un·e ennemi·e. Iel subit −Rang à son prochain jet, et tu apprends une chose vraie sur lui.',
          ...
          variantes: [
            ...
            { nom: 'Devant témoins', texte: 'L’aveu est public : conséquences sociales immédiates, et un·e allié·e gagne +2 contre la cible.' }] },
        { nom: 'Recoupement',
          fer: 'Tu déclares que tu avais prévu. Tu agis en premier, et un·e allié·e aussi.',
          calme: 'En croisant deux indices, tu obtiens de lae meneureuse un fait qu’iel n’avait pas prévu de donner, et qui ne peut pas être faux. Jamais la solution de l’enquête.',
          variantes: [
    ...
    { id: 'ecorce', nom: 'Écorce', stats: ['seve', 'verbe'], devise: 'Les serments qui poussent.',
      greffes: [
        { nom: 'Pacte',
          ...
          variantes: [
            { nom: 'Serment de garde', texte: 'Tu prends tous les dégâts d’un·e allié·e à sa place au lieu de partager.' },
            { nom: 'Contre-lettre', texte: 'Une clause reste cachée, visible seulement de qui la connait.' }] },
        { nom: 'Éveiller',
          ...
          variantes: [
            { nom: 'Domestique', texte: 'La chose reste éveillée Rang tours et agit sans couter ton action, mais n’attaque qu’une fois. 6 PV, Défense 11.' },
  ...
  var OUTILS = [
    ...
    { id: 'panier', nom: 'Panier creux', permet: 'Il contient trois fois ce qu’il devrait.',
      prend: 'Il digère lentement : ce qu’on y laisse une nuit en ressort abimé.' },
  ...
  var AMORCES = [
    ...
    'On m’a greffé quelque chose que je n’avais pas demandé, et ___ connait le nom du greffeur.'
  ];
